 ...
 *
 * This file is store-agnostic: it is parameterized over a store factory so every implementation —
 * memory today, DynamoDB next — is held to the identical invariant.
 */
